...
"[project]/soulfullbites/lib/security.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function getClientIp() {
    const headerStore = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$soulfullbites$2f$node_modules$2f$next$2f$headers$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["headers"])(); // NEXT.js 16 REQUIREMENT: Await headers()
...
"[project]/soulfullbites/app/api/user-auth/route.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$soulfullbites$2f$lib$2f$auth$2d$core$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/soulfullbites/lib/auth-core.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$soulfullbites$2f$lib$2f$security$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/soulfullbites/lib/security.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$crypto__$5b$external$5d$__$28$node$3a$crypto$2c$__cjs$29$__ = __turbopack_context__.i("[externals]/node:crypto [external] (node:crypto, cjs)");
;
;
;
...
;
async function GET() {
    const userPayload = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$soulfullbites$2f$lib$2f$user$2d$auth$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["getUserFromCookies"])();
    if (!userPayload) return __TURBOPACK__imported__module__$5b$project$5d2f$soulfullbites$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        user: null
    });
    try {
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$soulfullbites$2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ensureUsersTable"])();
        const rows = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$soulfullbites$2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["dbQuery"])('SELECT * FROM users WHERE id = $1 LIMIT 1', [
            userPayload.sub
        ]);
        const user = rows[0];
        if (!user || !user.is_active) {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$soulfullbites$2f$lib$2f$user$2d$auth$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["setUserCookie"])(null); // Clear invalid session
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$soulfullbites$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            user: (0, __TURBOPACK__imported__module__$5b$project$5d2f$soulfullbites$2f$lib$2f$user$2d$auth$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["sanitizeUser"])(user)
        });
    } catch (err) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$soulfullbites$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
async function POST(request) {
    const ip = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$soulfullbites$2f$lib$2f$security$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getClientIp"])();
    if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$soulfullbites$2f$lib$2f$security$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["checkRateLimit"])(`login_${ip}`, 5)) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$soulfullbites$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
    ...
    if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$soulfullbites$2f$lib$2f$security$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["checkOrigin"])(request)) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$soulfullbites$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: 'Forbidden'
        }, {
            status: 403
    ...
    try {
        ...
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$soulfullbites$2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ensureUsersTable"])();
        const rows = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$soulfullbites$2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["dbQuery"])('SELECT * FROM users WHERE email = $1 LIMIT 1', [
        ...
        const valid = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$soulfullbites$2f$lib$2f$user$2d$auth$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["verifyPassword"])(password.trim(), user.password_hash);
        if (!valid) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$soulfullbites$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: 'Invalid email or password'
            }, {
        ...
        const token = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$soulfullbites$2f$lib$2f$auth$2d$core$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["issueUserToken"])(user);
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$soulfullbites$2f$lib$2f$user$2d$auth$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["setUserCookie"])(token);
        return __TURBOPACK__imported__module__$5b$project$5d2f$soulfullbites$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            success: true,
            user: (0, __TURBOPACK__imported__module__$5b$project$5d2f$soulfullbites$2f$lib$2f$user$2d$auth$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["sanitizeUser"])(user)
        });
...
async function PUT(request) {
    const ip = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$soulfullbites$2f$lib$2f$security$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getClientIp"])();
    if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$soulfullbites$2f$lib$2f$security$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["checkRateLimit"])(`reg_${ip}`, 3)) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$soulfullbites$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
    ...
    try {
        ...
        // 1. Honeypot check
        if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$soulfullbites$2f$lib$2f$security$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["checkHoneypot"])(body)) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$soulfullbites$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                success: true,
                _bot: true
            }, {
        ...
        // 2. hCaptcha check
        const captchaValid = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$soulfullbites$2f$lib$2f$security$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["verifyHCaptcha"])(body.hcaptchaToken);
        if (!captchaValid) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$soulfullbites$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ...
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$soulfullbites$2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ensureUsersTable"])();
        const existing = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$soulfullbites$2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["dbQuery"])('SELECT id FROM users WHERE email = $1 LIMIT 1', [
            email.toLowerCase().trim()
        ]);
        ...
        const id = `USR-${Date.now().toString(36)}-${__TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$crypto__$5b$external$5d$__$28$node$3a$crypto$2c$__cjs$29$__["default"].randomBytes(3).toString('hex')}`;
        const passwordHash = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$soulfullbites$2f$lib$2f$user$2d$auth$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["hashPassword"])(password.trim());
    ...
    `, [
        ...
        const user = rows[0];
        const token = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$soulfullbites$2f$lib$2f$auth$2d$core$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["issueUserToken"])({
            ...user,
...
async function DELETE() {
    await (0, __TURBOPACK__imported__module__$5b$project$5d2f$soulfullbites$2f$lib$2f$user$2d$auth$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["setUserCookie"])(null);
    return __TURBOPACK__imported__module__$5b$project$5d2f$soulfullbites$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        success: true
    });
}
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0zkhrsz._.js.map