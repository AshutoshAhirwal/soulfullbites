...
"[project]/soulfullbites/lib/products.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function getProducts({ status = 'all', sort = 'created_at:asc' } = {}) {
    if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$soulfullbites$2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["hasDatabase"])()) {
        ...
        // Simple sort for default products
    ...
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$soulfullbites$2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["dbQuery"])(`SELECT * FROM products ${where} ORDER BY ${orderBy}`, values);
}
async function upsertProduct(product) {
    ...
    const images = images_json || JSON.stringify([
        image_slug || 'chocolate_bar.png'
    ]);
...
async function deleteProduct(id) {
    ...
    await (0, __TURBOPACK__imported__module__$5b$project$5d2f$soulfullbites$2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ensureOrdersTable"])();
    await (0, __TURBOPACK__imported__module__$5b$project$5d2f$soulfullbites$2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["dbQuery"])('DELETE FROM products WHERE id = $1', [
        id
    ]);
}
...
"[project]/soulfullbites/app/api/admin/products/route.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$soulfullbites$2f$lib$2f$products$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/soulfullbites/lib/products.js [app-route] (ecmascript)");
...
async function GET(request) {
    if (!await (0, __TURBOPACK__imported__module__$5b$project$5d2f$soulfullbites$2f$lib$2f$permissions$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["hasPermission"])('products.view')) {
    ...
    try {
        const products = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$soulfullbites$2f$lib$2f$products$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getProducts"])({
            status,
            sort
        });
        return __TURBOPACK__imported__module__$5b$project$5d2f$soulfullbites$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(products);
    } catch (err) {
...
async function POST(request) {
    if (!await (0, __TURBOPACK__imported__module__$5b$project$5d2f$soulfullbites$2f$lib$2f$permissions$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["hasPermission"])('products.create') && !await (0, __TURBOPACK__imported__module__$5b$project$5d2f$soulfullbites$2f$lib$2f$permissions$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["hasPermission"])('products.edit')) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$soulfullbites$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: 'Access denied'
        }, {
            status: 403
    ...
    try {
        ...
        const product = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$soulfullbites$2f$lib$2f$products$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["upsertProduct"])(body);
        return __TURBOPACK__imported__module__$5b$project$5d2f$soulfullbites$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            success: true,
            product
        });
...
async function DELETE(request) {
    if (!await (0, __TURBOPACK__imported__module__$5b$project$5d2f$soulfullbites$2f$lib$2f$permissions$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["hasPermission"])('products.delete')) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$soulfullbites$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: 'Access denied'
        }, {
            status: 403
    ...
    try {
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$soulfullbites$2f$lib$2f$products$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["deleteProduct"])(id);
        return __TURBOPACK__imported__module__$5b$project$5d2f$soulfullbites$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            success: true
        });
    } catch (err) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0d.bwm~._.js.map