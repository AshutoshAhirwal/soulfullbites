...
"[project]/soulfullbites/app/api/admin/users/route.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    if (!await (0, __TURBOPACK__imported__module__$5b$project$5d2f$soulfullbites$2f$lib$2f$permissions$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["hasPermission"])('users.view')) {
    ...
    try {
        ...
        const rows = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$soulfullbites$2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["dbQuery"])(`SELECT id, email, name, phone, role, is_active, avatar_url, created_at, updated_at FROM users ${where} ORDER BY ${orderBy} LIMIT 200`, values);
        return __TURBOPACK__imported__module__$5b$project$5d2f$soulfullbites$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            success: true,
            users: rows
        });
...
async function POST(request) {
    if (!await (0, __TURBOPACK__imported__module__$5b$project$5d2f$soulfullbites$2f$lib$2f$permissions$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["hasPermission"])('users.create')) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$soulfullbites$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: 'Access denied'
        }, {
            status: 403
    ...
    try {
        ...
        const newId = `USR-${Date.now().toString(36)}-${__TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$crypto__$5b$external$5d$__$28$node$3a$crypto$2c$__cjs$29$__["default"].randomBytes(3).toString('hex')}`;
...
async function PATCH(request) {
    ...
    if (!id) return __TURBOPACK__imported__module__$5b$project$5d2f$soulfullbites$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
    ...
    if (isEditingRoles && !await (0, __TURBOPACK__imported__module__$5b$project$5d2f$soulfullbites$2f$lib$2f$permissions$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["hasPermission"])('users.manage_roles')) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$soulfullbites$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: 'Permission denied for role updates'
        }, {
            status: 403
        });
    }
    if (!await (0, __TURBOPACK__imported__module__$5b$project$5d2f$soulfullbites$2f$lib$2f$permissions$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["hasPermission"])('users.edit')) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$soulfullbites$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: 'Access denied'
        }, {
            status: 403
    ...
    try {
        ...
        if (fields.length === 0) return __TURBOPACK__imported__module__$5b$project$5d2f$soulfullbites$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: 'No updates provided'
        }, {
            status: 400
        });
        values.push(id);
        const rows = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$soulfullbites$2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["dbQuery"])(`UPDATE users SET ${fields.join(', ')}, updated_at = NOW() WHERE id = $${values.length} RETURNING id, email, name, role, is_active, permission_overrides, created_at`, values);
        if (!rows[0]) return __TURBOPACK__imported__module__$5b$project$5d2f$soulfullbites$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
async function DELETE(request) {
    if (!await (0, __TURBOPACK__imported__module__$5b$project$5d2f$soulfullbites$2f$lib$2f$permissions$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["hasPermission"])('users.delete')) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$soulfullbites$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: 'Access denied'
        }, {
            status: 403
    ...
    try {
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$soulfullbites$2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["dbQuery"])('DELETE FROM users WHERE id = $1', [
            id
        ]);
        return __TURBOPACK__imported__module__$5b$project$5d2f$soulfullbites$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            success: true
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0~x65zi._.js.map